...
> v0.7.1 - 记忆和课程表修复版 ✅ | v0.5.0 - Active Perception层 | v0.4.0 - Action层

个人 AI 助手，支持长期记忆、对话管理、用户行为学习、工具调用和任务执行、**主动提醒和实时推送**、**智能图片记忆**、**课程表管理**。
