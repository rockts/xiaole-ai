...
> v0.8.1 - 提醒系统修复版 🎉 | 当前稳定版本

> 🚧 develop 分支：v0.9.0 前端架构升级（Vue 3 + Vite）

> 📌 **最新修复 (2025-11-29)**: 提醒系统调度器和 WebSocket 推送完全修复！详见 [v0.8.1修复报告](docs/v0.8.1_REMINDER_FIX.md)
...
### 👁️ 视觉能力升级（规划中）
- **本地人脸识别**：基于 `face_recognition` 实现离线人脸库，保护隐私
- **视频流交互**：实时视频通话，结合人脸识别实现"看到人打招呼"
