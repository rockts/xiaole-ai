...
- [ ] **显示验证** - 图片仍不显示，需进一步排查（状态码304缓存问题）

### 🗺️ 规划中
- 优化Markdown渲染性能（marked.js配置调优）
- 实现图片预览和放大功能
- 添加消息引用回复功能
- 完善移动端触摸交互体验
- 分享卡片智能排版（多图网格、长文分栏）
...
#### Phase 2.3: ChatView 对齐 ChatGPT + 文档清理 ✅（2025-11-19）
- [x] ChatView 布局：AI 左对齐透明、用户右对齐气泡（统一最大宽度约 740px）
- [x] Markdown 体验：代码块复制按钮、表格/列表/引用样式优化
- [x] 图片体验：对话与 Markdown 图片点击放大预览（遮罩层）
