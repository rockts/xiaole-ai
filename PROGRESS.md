...
- [x] **人脸管理界面** - 实现人脸列表查看与删除功能 (FacesView.vue)
- [x] **前端重构** - 修复 FacesView 依赖问题，统一使用 api.js 服务层
...
#### Phase 2.4: 细节体验优化 ✅（2025-11-25）
- [x] **分享卡片优化** - 长文本自动分栏显示，提升阅读体验
- [x] **侧边栏菜单优化** - 使用 Teleport 避免裁剪，实现智能翻转与对齐
