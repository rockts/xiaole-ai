...
def generate_test_data():
    ...
    try:
        ...
        for i in range(5):
            ...
            start_time = datetime.now() - timedelta(days=days_ago, hours=24-hours, minutes=random.randint(0, 59))
            ...
            print(f"✅ 生成会话 {i+1}: {topics}, {message_count}条消息, {duration_seconds}秒")
